...
function processVideo() {
  if (playing.value) {
    ...
    if (!contextRead || !contextDraw) {
      contextRead = canvasRead.value.getContext("2d", {
        willReadFrequently: true,
      });
      contextDraw = canvasOutput.value.getContext("2d", {
        willReadFrequently: true,
      });
    }
        ...
        <div class="videoController">
          ...
          <div class="controllerCenter">
            ...
            <div class="centerIcon" v-if="!playing" @click="play(true)">
              <!-- <VideoPlay /> -->
              <el-icon :size="playerIconSize" v-if="!playing"
                ><VideoPlay
              /></el-icon>
            </div>
